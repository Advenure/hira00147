      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-16 max-lg:max-w-3xl max-md:max-w-md mx-auto">
          <div className="bg-white cursor-pointer rounded overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] relative top-0 hover:-top-2 transition-all duration-300">
            ...
            <Image src={'/image copy 2.png'} alt="image" height={60} width={200} className="object-cover place-items-center w-full h-60" ></Image>
            <div className="p-6">
          ...
          <div className="bg-white cursor-pointer rounded overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] relative top-0 hover:-top-2 transition-all duration-300">
          <Image src={'/image copy.png'} alt="image" height={60} width={200} className="object-cover place-items-center w-full h-60" ></Image>
            <div className="p-6">
          ...
          <div className="bg-white cursor-pointer rounded overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] relative top-0 hover:-top-2 transition-all duration-300">
          <Image src={'/image.png'} alt="image" height={60} width={200} className="object-cover place-items-center w-full h-60" ></Image>
            <div className="p-6">
